...
class SoyoungSpider(scrapy.Spider):
    ...
    start_urls = ['http://www.soyoung.com/searchNew/product?keyword=%E4%BC%8A%E5%A9%89&cityId=null&_json=1&page_size=2000&page=1&sort=0&service=&coupon=&group=&maxprice=&minprice=']
